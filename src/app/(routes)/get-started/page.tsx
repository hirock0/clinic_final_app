    ...
    return (
        <section className='max-w-[1440px] mx-auto w-11/12 flex items-center flex-col justify-center py-12 lg:py-20'>
            <div className="mx-auto text-center mb-6 md:mb-10">
                <h1 className='main-text-color text-4xl font-black mb-4'>Get Started With UCL</h1>
                <p className='text-xl font-medium'>We help companies find great talent — and great talent find great jobs.</p>
            </div>
