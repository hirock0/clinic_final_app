...
const HireTalentPage = () => {
  ...
  return (
    <section className="scroll-mt-40 max-w-4xl mx-auto p-6 rounded-lg shadow-md my-12 md:my-20">
        ...
        <div className="border-b border-gray-200 pb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              />
              {errors.city && (
                <span className="text-red-500 text-sm">City Required</span>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.state && (
                <span className="text-red-500 text-sm">State Required</span>
              )}
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-2">
                      ...
                      {...register("staffNeeded", {
                        validate: (value) =>
                          value && value.length > 0
                            ? true
                            : "Please select at least one staff type",
                      })}
                ...
                {errors.staffNeeded && (
                  <span className="text-red-500 text-sm">
                    Staffing Request Details Required
                  </span>
                )}
              </div>
                    ...
                    <input
                      ...
                      {...register("shiftsNeeded", {
                        validate: (value, formValues) =>
                          (formValues.shiftsNeeded?.length ?? 0) > 0 ||
            ...
            <div>
              ...
              {errors.assignmentDuration && (
                <span className="text-red-500 text-sm">
                  Assignment Duration Required
                </span>
              )}
            </div>
