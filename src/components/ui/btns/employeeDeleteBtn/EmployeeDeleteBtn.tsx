...
const EmployeeDeleteBtn = ({ item, setDeleteId }: any) => {
  ...
  return (
    <div className="">
      <button
        ...
        disabled={loading}
        className="flex items-center gap-1 text-red-600 hover:text-red-800 hover:bg-yellow-300/20 p-2 rounded-sm  transition duration-200 text-sm font-medium disabled:opacity-50"
      >
...
export default EmployeeDeleteBtn;
